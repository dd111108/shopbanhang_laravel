                    ...
                    <div class="basic-form">
                        <form action="{{URL::to('/save-category-product')}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" rows="4" id="comment" name ="category_product_desc" required=""></textarea>
                            </div>
                            <label class="col-sm-3 col-form-label">Hiển thị</label>
                                <select class="default-select form-control wide mb-3" name="category_product_status" required="">
