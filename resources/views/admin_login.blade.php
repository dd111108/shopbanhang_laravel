...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="{{('public/backend/images/favicon.png')}}">
...
<body class="vh-100">
                                        ...
                                        <div class="row d-flex justify-content-between mt-4 mb-2">
                                            <div class="mb-3">
                                               <div class="form-check custom-checkbox ms-1">
													...
													<label class="form-check-label" for="basic_checkbox_1">Ghi nhớ mật khẩu</label>
												</div>
                                            </div>
                                            <div class="mb-3">
    ...
    ***********************************-->
    ...
    <script src="{{('public/backend/js/dlabnav-init.js')}}"></script>
	<script src="{{('public/backend/js/styleSwitcher.js')}}"></script>
</body>
</html>