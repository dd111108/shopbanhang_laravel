  ...
  public function AuthLogin(){
    ...
    public function add_product(){
      ...
      public function all_product(){
        $this->AuthLogin();
         $all_product = DB::table('tbl_product')->join('tbl_category_product','tbl_category_product.category_id','=','tbl_product.category_id')->join('tbl_brand','tbl_brand.brand_id','=','tbl_product.brand_id')->orderby('product_id','desc')->get();
    ...
    $post = DB::table('tbl_product')->where('product_id', $product_id)->first();
    ...
    if ($get_image) {
        ...
        // Lấy tên hình ảnh cũ
        $old_image = $post->product_image;

        // Cập nhật cơ sở dữ liệu với hình ảnh mới
        DB::table('tbl_product')->where('product_id', $product_id)->update($data);

        // Xóa hình ảnh cũ khỏi hệ thống tập tin nếu tồn tại
        if ($old_image && file_exists(public_path('public/uploads/product/' . $old_image))) {
            unlink(public_path('public/uploads/product/' . $old_image));
        }
    ...
    public function delete_product($product_id){
        $this->AuthLogin();
         ...
         if ($product) {
             ...
             // Xóa hình ảnh cũ khỏi hệ thống tập tin nếu tồn tại
             if ($old_image && file_exists(public_path('uploads/product/' . $old_image))) {
             ...
             return Redirect::to('all-product')->with('success', 'Xóa sản phẩm thành công');
         }
 
         // Nếu sản phẩm không tồn tại, chuyển hướng với thông báo lỗi
